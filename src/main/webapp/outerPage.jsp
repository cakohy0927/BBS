				...
				<form id="queryForm" name="queryForm">
					<div class="row" style="margin-top:5px;margin-bottom:5px;">
						<div class="form-group">
							...
							<label for="name" class="col-sm-2 control-label" style="margin-left: -2px;">
								<button class="btn btn-primary" type="button" onclick="" style="width:auto;margin-right:15px;">搜索</button>
							</label>
						</div>
					</div>
				</form>
